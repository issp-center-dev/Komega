...
% Cover
%
\title{Shifted Krylov法ライブラリ設計書 ver.0.6}
...
PROGRAM my_prog
  ...
  !
  COMPLEX(8) :: &
  & v12(:), v14(:), v2(:), v3(:), & ! (ndim): Working vector
  ...
  !
  ALLOCATE(v12(ndim), v14(ndim), v2(ndim), v3(ndim), &
  ...
  DO iter = itermin, itermax
    ...
    CALL matrix_product(v3, v14)
    !
    ! Update result x with BiCG
    !
    CALL BiCG_update(v12, v14, v2, v3, x, rsmall, lconverged)
    !
  ...
  !
  DEALLOCATE(r, r_old, r_tilde, r_old, alpha, beta, zseed, rsmall_save)
  DEALLOCATE(v12, v14, v2, v3, rsmall, x, z)
  !
END PROGRAM my_prog
\end{lstlisting}
