...
\begin{verbatim}
CALL pCG_R_init(ndim, nl, nz, x, z, itermax, threshold, comm)
CALL pCG_C_init(ndim, nl, nz, x, z, itermax, threshold, comm)
CALL pCOCG_init(ndim, nl, nz, x, z, itermax, threshold, comm)
CALL pBiCG_init(ndim, nl, nz, x, z, itermax, threshold, comm)
\end{verbatim}
...
\begin{verbatim}
CALL pCG_R_restart(ndim, nl, nz, x, z, itermax, threshold, comm, status, &
&                 iter_old, v2, v12, alpha_save, beta_save, z_seed, r_l_save)
CALL pCG_C_restart(ndim, nl, nz, x, z, itermax, threshold, comm, status, &
&                 iter_old, v2, v12, alpha_save, beta_save, z_seed, r_l_save)
CALL pCOCG_restart(ndim, nl, nz, x, z, itermax, threshold, comm, status, &
&                 iter_old, v2, v12, alpha_save, beta_save, z_seed, r_l_save)
CALL pBiCG_restart(ndim, nl, nz, x, z, itermax, threshold, comm, status, &
&                 iter_old, v2, v12, v4, v14, alpha_save, beta_save, &
&                 z_seed, r_l_save)
\end{verbatim}
...
\noindent Fortran (MPI/ハイブリッド並列版)
\begin{verbatim}
CALL pCG_R_update(v12, v2, x, r_l, status)
CALL pCG_C_update(v12, v2, x, r_l, status)
CALL pCOCG_update(v12, v2, x, r_l, status)
CALL pBiCG_update(v12, v2, v14, v4, x, r_l, status)
\end{verbatim}
...
\noindent Fortran (MPI/ハイブリッド並列版)
\begin{verbatim}
CALL pCG_R_getcoef(alpha_save, beta_save, z_seed, r_l_save)
CALL pCG_C_getcoef(alpha_save, beta_save, z_seed, r_l_save)
CALL pCOCG_getcoef(alpha_save, beta_save, z_seed, r_l_save)
CALL pBiCG_getcoef(alpha_save, beta_save, z_seed, r_l_save)
\end{verbatim}
...
\noindent Fortran (MPI/ハイブリッド並列版)
\begin{verbatim}
CALL pCG_R_getvec(r_old)
CALL pCG_C_getvec(r_old)
CALL pCOCG_getvec(r_old)
CALL pBiCG_getvec(r_old, r_tilde_old)
\end{verbatim}
